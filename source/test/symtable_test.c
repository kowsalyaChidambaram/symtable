...
static void test_SymTable_free(SymTable_t oSymTable)
{
...
static void test_SymTable_getLength(SymTable_t oSymTable)
{
	assert(oSymTable != NULL);
...
static void function(const char* pcKey, const void* pvValue, void* pvExtra) 
{
	printf("\n%s\t%s", pcKey, pvValue);
}
//test mapping a function to "SymTable_map"
static void test_SymTable_map(SymTable_t oSymTable)
{
	assert(oSymTable != NULL);
...
static void test_SymTable_contains(SymTable_t oSymTable)
{
	assert(oSymTable != NULL);
...
static void test_SymTable_put(SymTable_t oSymTable)
{
	assert(oSymTable != NULL);
	int put_returns;
	int count = 32749;
...
static void test_SymTable_get(SymTable_t oSymTable)
{
	assert(oSymTable != NULL);
	void* temp;
	...
	printf("test success: test_SymTable_get right flow \n");
}
//tests the functions "SymTable_remove" 
static void test_SymTable_remove (SymTable_t oSymTable)
{
	...
	printf("test success: SymTable_remove right flow \n");
}
//tests the functions "SymTable_replace"
static void test_SymTable_replace (SymTable_t oSymTable)
{
	void *temp;
	...
	printf("test success: SymTable_replace right flow \n");
}
